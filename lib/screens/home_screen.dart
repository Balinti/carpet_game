                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Square Building modes section
                        _SectionHeader(
                          title: l10n.squareModes,
                          icon: Icons.crop_square,
                          color: Colors.deepPurple,
                        ),
                        const SizedBox(height: 12),
                        _GameModeCard(
                          title: l10n.square2x2,
                          subtitle: l10n.square2x2Desc,
                          icon: Icons.grid_3x3,
                          iconColor: Colors.purple,
                        ...
                        const SizedBox(height: 12),
                        _GameModeCard(
                          title: l10n.square3x3,
                          subtitle: l10n.square3x3Desc,
                          icon: Icons.grid_4x4,
                        ...
                        const SizedBox(height: 12),
                        _GameModeCard(
                          title: l10n.square4x4,
                          subtitle: l10n.square4x4Desc,
                          icon: Icons.grid_on,
                          iconColor: Colors.indigo,
                        ...
                        const SizedBox(height: 12),
                        _GameModeCard(
                          title: l10n.squareProgression,
                          subtitle: l10n.squareProgressionDesc,
